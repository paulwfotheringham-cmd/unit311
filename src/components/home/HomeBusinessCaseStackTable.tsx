  ...
  return (
    <div className="flex h-full flex-col">
      <div className="mb-5 sm:mb-6">
        <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-white/90 sm:text-[13px]">
          Illustrative Technology Stack
        </h3>
        <p className="mt-2 text-[11px] leading-relaxed text-white/45 sm:text-xs">
          Typical software used by a growing business (approximately 10 users)
        </p>
      </div>
