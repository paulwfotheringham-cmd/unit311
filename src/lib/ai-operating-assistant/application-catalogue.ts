...
const MODULE_ALIASES: Record<string, string[]> = {
  ...
  "technology-management": ["technology", "tech", "it", "devices", "software", "infrastructure"],
  ...
  engineering: ["engineers", "capacity", "resourcing"],
...
const MODULE_DESCRIPTIONS: Record<string, string> = {
  ...
  "technology-management": "Devices, software, telecommunications, and infrastructure.",
  "business-productivity": "Files, email, calendar, messaging, communications, and support desk.",
  ...
  engineering: "Engineer resourcing and capacity planning.",
